...
class DioSettings {
  ...
  Dio dio = Dio(
    BaseOptions(
      baseUrl: 'https://berlin-backender.org.kg/lorby/',
  ...
  Future<void> setup() async {
    ...
    final QueuedInterceptorsWrapper headerInterceppors=QueuedInterceptorsWrapper(
    ...
    interceptors.addAll([if(kDebugMode)logInterceptor,headerInterceppors]);
